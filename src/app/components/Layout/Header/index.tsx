      ...
      <div className='lg:py-0 py-2'>
        <div className='container mx-auto max-w-(--breakpoint-xl) flex items-center justify-between px-4'>
          ...
          <div
            ...
            <Link
              href='/contact'
              className='hidden lg:block bg-primary text-white text-base font-semibold px-6 py-3 rounded-full hover:bg-darkmode hover:cursor-pointer transition-colors duration-300'>
              Free Strategy Call
            </Link>
            <button
        ...
        <div
          ...
          <nav className='flex flex-col items-start p-4'>
            ...
            <div className='mt-4 flex flex-col space-y-4 w-full'>
              <Link
                href='/contact'
                className='bg-primary text-white text-center px-4 py-3 rounded-full hover:bg-deep-slate transition-colors duration-300 font-semibold'
                onClick={() => {
                  setNavbarOpen(false)
                }}>
                Free Strategy Call
